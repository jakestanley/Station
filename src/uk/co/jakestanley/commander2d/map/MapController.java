...
import uk.co.jakestanley.commander2d.tiles.VisibleTile;
...
public class MapController {
    ...
    public MapController(String mapFileName){ // TODO CONSIDER RoomBuilder class - instead of "RoomController"?
        ...
        // Load uk.co.jakestanley.commander2d.map
...
//        generateDoors();
    ...
    public void init(){
        initialiseTiles(); // set all uk.co.jakestanley.commander2d.tiles as void uk.co.jakestanley.commander2d.tiles
    ...
    public void createRoom(ArrayList<Point> points, boolean force){
        ...
        // remove any rooms that now contain no uk.co.jakestanley.commander2d.tiles // TODO CONSIDER should this go before new room initialisation? i dunno...
        cleanupRooms();
...
//        clearDoors(); // TODO properly. consider making this into a thing that updates walls and doors?
    ...
    private void initialiseTiles(){
        ...
        // Add all uk.co.jakestanley.commander2d.tiles as first room
...
//    public Room createRoom(ArrayList<Point> points, boolean useVoid){ // TODO need more variables // TODO remove a room if it no longer has any uk.co.jakestanley.commander2d.tiles in update method
//
...
//
//            if(useVoid || !getTile(next).isVoid()){ // if using void uk.co.jakestanley.commander2d.tiles is permitted, or it's not a void tile
//
//                // initialise the tile
//                initialiseTile(next);
//
//                // create new visible uk.co.jakestanley.commander2d.tiles
//                int x = (int) next.getX();
//                int y = (int) next.getY();
//                uk.co.jakestanley.commander2d.tiles[x][y] = new VisibleTile(x, y, room); // TODO CONSIDER change to Point?
//            }
//
//        }
//
...
//    }
    ...
    public void generateDoors(){
        ...
        // generate new doors // TODO CONSIDER should all doors update? maybe cache could only update select uk.co.jakestanley.commander2d.tiles (e.g by association checks?)
...
//                System.out.println("Door match");
    ...
    public void renderWalls(Graphics screen){ // TODO cache these in an arraylist and use an iterator if it proves to be quicker. run tests. re-cache on changing uk.co.jakestanley.commander2d.tiles
        for(int x = 0; x < tiles.length; x++){
            for(int y = 0; y < tiles[x].length; y++){
                if(!tiles[x][y].isVoid()){
                    VisibleTile visibleTile = (VisibleTile) tiles[x][y];
    ...
    public void releaseDrag(){
        // add selected uk.co.jakestanley.commander2d.tiles to selection
    ...
    public void createRoomFromSelection(){
        ...
        for (Iterator<Point> iterator = selection.iterator(); iterator.hasNext(); ) { // TODO EFFICIENCY change the flow of this code so it just ignores void uk.co.jakestanley.commander2d.tiles for
            Point next = iterator.next();
    ...
    /**
     * Clear selected uk.co.jakestanley.commander2d.tiles
     */
