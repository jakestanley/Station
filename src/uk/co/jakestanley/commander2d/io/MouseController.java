package uk.co.jakestanley.commander2d.io;

import uk.co.jakestanley.commander2d.main.ContextController;
...
public class MouseController implements MouseListener { // TODO improve and abstract
    ...
    public void setMousePoint(Point mousePoint){
        ...
        // Clear uk.co.jakestanley.commander2d.map hover objects
    ...
    /**
     * Priority: focused dialogs, then uk.co.jakestanley.commander2d.map or static components
     * @param mousePoint
     */
    public void setClickPoint(Point mousePoint){
        ...
        // get uk.co.jakestanley.commander2d.map and context controller and check for uk.co.jakestanley.commander2d.map clicks
        ...
        if((cc.getContext() == ContextController.BUILD_ROOM) && isMouseOverMap(mousePoint)){ // If in construction context and mouse is over uk.co.jakestanley.commander2d.map
    ...
    private boolean isMouseOverMap(Point point){
        ...
        // TODO CONSIDER checking if the uk.co.jakestanley.commander2d.map is visible
