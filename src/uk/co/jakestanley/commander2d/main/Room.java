...
public class Room implements Interactable, Inputtable { // TODO make abstract
    ...
    private void calculateRates(){
        ventRate           = BASE_PURGE_RATE / points.size(); // TODO consider isn't this just uk.co.jakestanley.commander2d.tiles.length?
...
//        }
//
//        for (Iterator<Point> iterator = uk.co.jakestanley.commander2d.tiles.iterator(); iterator.hasNext(); ) {
//            Point next = iterator.next();
...
//        strings.add(StringUtils.capitalize(typeString));
    ...
    public void update(){
        ...
        // count uk.co.jakestanley.commander2d.mobs in room
...
//
//        uk.co.jakestanley.commander2d.tiles = new ArrayList<Point>();
//
//        if(isCorridor()){ // if its a corridor // TODO clean up
//            System.out.println("generating corridor uk.co.jakestanley.commander2d.tiles");
...
//                    Game.uk.co.jakestanley.commander2d.map.uk.co.jakestanley.commander2d.tiles[x][y + ly] = tile; // switch out from the array
//                    uk.co.jakestanley.commander2d.tiles.add(tile); // add to the list of tracked uk.co.jakestanley.commander2d.tiles for this room
////                    uk.co.jakestanley.commander2d.tiles.add(new Tile(this, x, y + ly*Display.TILE_WIDTH, Tile.TYPE_CORRIDOR_Y));
//                }
//            } else { // else do a horizontal corridor
//                for(int lx = 0; lx < sx; lx++){
//                    Tile tile = new VisibleTile(x + lx, y, this, type);
//                    Game.uk.co.jakestanley.commander2d.map.uk.co.jakestanley.commander2d.tiles[x + lx][y] = tile; // switch out from the array
//                    uk.co.jakestanley.commander2d.tiles.add(tile); // add to the list of tracked uk.co.jakestanley.commander2d.tiles for this room
////                    uk.co.jakestanley.commander2d.tiles.add(new Tile(this, x + lx*Display.TILE_WIDTH, y, Tile.TYPE_CORRIDOR_X));
//                }
//            }
//
//        } else { // if its a regular tile
//            for(int lx = 0; lx < sx; lx++){ // TODO tile generation should be dynamic and uk.co.jakestanley.commander2d.tiles should look different
//                for(int ly = 0; ly < sy; ly++){ // l is local
//
//                    Tile tile = new VisibleTile(x + lx, y + ly, this, type);
//                    Game.uk.co.jakestanley.commander2d.map.uk.co.jakestanley.commander2d.tiles[x + lx][y + ly] = tile; // switch out from the array
//                    uk.co.jakestanley.commander2d.tiles.add(tile); // add to the list of tracked uk.co.jakestanley.commander2d.tiles for this room
////                    uk.co.jakestanley.commander2d.tiles.add(new Tile(this, x + (lx*Display.TILE_WIDTH), y + (ly*Display.TILE_WIDTH), Tile.TYPE_SQUARE)); // TODO do the multiplication in the render method only
//
//                }
//            }
//
