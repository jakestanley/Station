...
import uk.co.jakestanley.commander2d.gui.HintsBox;
import uk.co.jakestanley.commander2d.gui.actions.SwitchViewAction;
import uk.co.jakestanley.commander2d.gui.inspectors.BuildInspector;
import uk.co.jakestanley.commander2d.gui.inspectors.GeneralInspector;
import uk.co.jakestanley.commander2d.gui.inspectors.Inspector;
import uk.co.jakestanley.commander2d.gui.inspectors.PlaceInspector;
import uk.co.jakestanley.commander2d.gui.widgets.Button;
import uk.co.jakestanley.commander2d.gui.widgets.ButtonRow;
import uk.co.jakestanley.commander2d.mobs.Mob;
import org.newdawn.slick.Color;
import org.newdawn.slick.Graphics;
import org.newdawn.slick.TrueTypeFont;
import uk.co.jakestanley.commander2d.resources.FontLoader;
...
public class GuiController {
    ...
    public GuiController(){
        ...
        // construct uk.co.jakestanley.commander2d.gui components
...
//        messages = new MessageBox(null, 0); // TODO figure out what's going on here
    ...
    public void init(){
        ...
        // iterating over a hash uk.co.jakestanley.commander2d.map. yeah.
...
//        // DRAW HOVER DOOR INFORMATION
    ...
    /**
     * For sending clicks to non-uk.co.jakestanley.commander2d.map components and informing the caller that a click was registered by a component.
     * @param mouse
     * @return
     */
    public boolean click(Point mouse){
        for (Iterator<Component> iterator = visible.iterator(); iterator.hasNext(); ) {
            ...
            if(next.isMouseOver(mouse)){
                System.out.println("uk.co.jakestanley.commander2d.gui click");
                next.click(mouse);
                return true;
            }
        }
    ...
    /**
     * For sending hovers to non-uk.co.jakestanley.commander2d.map components and informing the caller that a click was registered by a component.
     * @param mouse
     * @return
     */
